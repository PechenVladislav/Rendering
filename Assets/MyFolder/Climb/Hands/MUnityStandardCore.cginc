...
#include "MUnityStandardInput.cginc"
#include "MUnityPBSLighting.cginc"
#include "UnityStandardUtils.cginc"
#include "UnityGBuffer.cginc"
#include "MUnityStandardBRDF.cginc"
...
half4 rim(FragmentCommonData s, float2 uv)
{
	float noise = tex2D(_RimTex, uv / 4 + _Time.x).r + 0.5;
	half4 rim = pow(1 - dot(-s.eyeVec, s.normalWorld), _RimPower) * _RimColor;
	rim = rim * (noise + rim);
	return rim; 
}
